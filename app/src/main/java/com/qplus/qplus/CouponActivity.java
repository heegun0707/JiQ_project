                    ...
                    if(selist.size()>0) {
                        for (int i = 0; i < selist.size(); i++) {
                            switch (selist.get(i).trim()){
                                case "Goods":  adapter.addItem("편의점", titlelist.get(i).trim(), "2020-12-31"); break;
                                case "Cafe":  adapter.addItem("카페", titlelist.get(i).trim(), "2020-12-31"); break;
                                case "Bakery":  adapter.addItem("베이커리", titlelist.get(i).trim(), "2020-12-31"); break;
                            }
