...
public class SetPostDataBase {
    ...
    public void Set_VolPostDatabase(Long time, String postNum, final String getUid, String name,
                                    ArrayList<String> ImgUri, String letter, ArrayList<String> likelist) {
