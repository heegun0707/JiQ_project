...
public class SetUserDataBase {
    ...
    public void SetUserSignDatabase(String uid, String id, String pass, String name, String phonenum,
                                    String message, Integer stamp, String qrimg, String profileimg,
                                    Integer post_count,  ArrayList<String> couponList) {
